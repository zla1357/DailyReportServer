...
class MenuItemServiceTest {
    ...
    public void Master_항목_저장() throws Exception {
        // given
        MenuItemDTO menuItemDTO = new MenuItemDTO(null, "메뉴1", null, null, ItemClass.MASTER, null);
    ...
    public void Sub_항목_저장() throws Exception {
        // given
        MenuItemDTO masterItemDTO = new MenuItemDTO(null, "메뉴1", null, null, ItemClass.MASTER, null);

        Long masterId = menuItemService.addMenuItem(masterItemDTO);
        MenuItem masterItem = menuItemService.getMenuItem(masterId);

        // when
        MenuItemDTO subItemDTO = new MenuItemDTO(null, "서브메뉴", null, masterItem, ItemClass.SUB, null);
        Long subId = menuItemService.addMenuItem(subItemDTO);
        MenuItem subItem = menuItemService.getMenuItem(subId);

        MenuItemDTO subItemDTO2 = new MenuItemDTO(null, "서브메뉴2", null, masterItem, ItemClass.SUB, null);
    ...
    public void sub_항목_조회() throws Exception {
        // given
        MenuItemDTO parentDTO = new MenuItemDTO(null, "업무일지", null, null, ItemClass.MASTER, null);
        Long parentId = menuItemService.addMenuItem(parentDTO);
        MenuItem parent = menuItemService.getMenuItem(parentId);

        MenuItemDTO subItemDTO = new MenuItemDTO(null, "업무일지 조회", null, parent, ItemClass.SUB, null);
        Long sub1Id = menuItemService.addMenuItem(subItemDTO);
        MenuItem subItem1 = menuItemService.getMenuItem(sub1Id);

        MenuItemDTO parentDTO2 = new MenuItemDTO(null, "업무일지 수정", null, parent, ItemClass.SUB, null);
